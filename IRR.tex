...
The main design aim of the SCWR is to increase the efficiency of LWR designs by operating at high temperatures and pressures, above the thermodynamic critical point of water \cite{GenIVRoadmap}.
The SCWR idea has been inspired by current state-of-the-art coal-fired power stations that have successfully increased efficiency while decreasing the capital cost required per unit electricity.
...
Operating at supercritical pressures presents opportunities for large cost savings and safety improvement. 
Water can only exist in a single homogeneous phase above the thermodynamic critical point.
Current BWR designs have a number of in-core devices to handle the phase change of water as it circulates the core \cite{Marques2010a}.
SCWRs do not require steam dryers, separators, recirculation pumps or steam generators which vastly simplifies the design, reducing both capital costs and O\&M costs.
This also has a positive impact on the safety performance of the reactor \cite{GenIVRoadmap}.
...
Reactor design could be either a pressure vessel design similar to the ABWR design, or a pressure tube design similar to the CANDU reactor \cite{Bhatnagar2011}.
